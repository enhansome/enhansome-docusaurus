...
* [docusaurus-plugin-lunr](https://github.com/daldridge/docusaurus-plugin-lunr) ⭐ 61 | 🐛 29 | 🌐 TypeScript | 📅 2023-08-19 - Create search index for use with Lunr.js.
...
* [@aeorank/docusaurus](https://github.com/vinpatel/aeorank/tree/main/packages/docusaurus) ⭐ 12 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-14 - Scores your docs site's AI visibility and generates the 9 files (llms.txt, ai.txt, CLAUDE.md, ...) that ChatGPT and Perplexity read.
...
* [docusaurus-theme-search-typesense](https://github.com/typesense/docusaurus-theme-search-typesense) ⭐ 84 | 🐛 19 | 🌐 TypeScript | 📅 2026-02-25 - Typesense search component.
* [cosmos-docusaurus-theme](https://github.com/SckyzO/cosmos-docusaurus-theme) ⭐ 1 | 🐛 5 | 🌐 CSS | 📅 2026-08-03 - Clean, dark-first, CSS-only theme with Void/Slate palettes, self-hosted Outfit + IBM Plex Mono, and WCAG AA colors.
