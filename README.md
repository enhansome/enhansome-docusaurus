...
* [docusaurus-openapi-docs](https://github.com/PaloAltoNetworks/docusaurus-openapi-docs/) ⭐ 1,103 | 🐛 91 | 🌐 TypeScript | 📅 2026-09-09 - Genertate Markdown documentation from an OpenAPI specification.
...
* [heroshot](https://github.com/omachala/heroshot) ⭐ 74 | 🐛 4 | 🌐 TypeScript | 📅 2026-06-28 - Screenshot automation with theme-aware component for light/dark mode and responsive viewports.
...
* [@aeorank/docusaurus](https://github.com/vinpatel/aeorank/tree/main/packages/docusaurus) ⭐ 14 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-11 - Scores your docs site's AI visibility and generates the 9 files (llms.txt, ai.txt, CLAUDE.md, ...) that ChatGPT and Perplexity read.
...
* [cosmos-docusaurus-theme](https://github.com/SckyzO/cosmos-docusaurus-theme) ⭐ 2 | 🐛 8 | 🌐 CSS | 📅 2026-09-07 - Clean, dark-first, CSS-only theme with Void/Slate palettes, self-hosted Outfit + IBM Plex Mono, and WCAG AA colors.
