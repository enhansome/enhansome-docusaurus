...
* [docusaurus-openapi-docs](https://github.com/PaloAltoNetworks/docusaurus-openapi-docs/) ⭐ 1,103 | 🐛 92 | 🌐 TypeScript | 📅 2026-09-02 - Genertate Markdown documentation from an OpenAPI specification.
...
* [@aeorank/docusaurus](https://github.com/vinpatel/aeorank/tree/main/packages/docusaurus) ⭐ 14 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-03 - Scores your docs site's AI visibility and generates the 9 files (llms.txt, ai.txt, CLAUDE.md, ...) that ChatGPT and Perplexity read.
