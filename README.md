...
* [docusaurus-openapi-docs](https://github.com/PaloAltoNetworks/docusaurus-openapi-docs/) ⭐ 1,104 | 🐛 94 | 🌐 TypeScript | 📅 2026-09-22 - Genertate Markdown documentation from an OpenAPI specification.
...
* [heroshot](https://github.com/omachala/heroshot) ⭐ 75 | 🐛 4 | 🌐 TypeScript | 📅 2026-06-28 - Screenshot automation with theme-aware component for light/dark mode and responsive viewports.
...
* [docusaurus-plugin-auto-sidebars](https://github.com/acrobit/docusaurus-plugin-auto-sidebars) ⭐ 24 | 🐛 27 | 🌐 JavaScript | 📅 2023-01-06 - Automatically generate sidebars from Markdown files.
...
* [@aeorank/docusaurus](https://github.com/vinpatel/aeorank/tree/main/packages/docusaurus) ⭐ 15 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-25 - Scores your docs site's AI visibility and generates the 9 files (llms.txt, ai.txt, CLAUDE.md, ...) that ChatGPT and Perplexity read.
...
* [cosmos-docusaurus-theme](https://github.com/SckyzO/cosmos-docusaurus-theme) ⭐ 3 | 🐛 12 | 🌐 CSS | 📅 2026-09-21 - Clean, dark-first, CSS-only theme with Void/Slate palettes, self-hosted Outfit + IBM Plex Mono, and WCAG AA colors.
